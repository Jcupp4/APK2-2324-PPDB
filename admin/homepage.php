...
<!-- Mirrored from snow-tail.netlify.app/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Feb 2025 12:39:08 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!-- Site favicon -->
    <link rel="shortcut icon" href="../assets/assetsdashboard/images/favicon.ico" />

    <!-- Custom Style -->
    <link rel="stylesheet" type="text/css" href="../assets/assetsdashboard/css/style.css" />
</head>
...
<body x-data="main" class="antialiased relative font-inter bg-white dark:bg-black text-black dark:text-white text-sm font-normal overflow-x-hidden vertical" :class="[ $store.app.sidebar ? 'toggle-sidebar' : '', $store.app.rightsidebar ? 'right-sidebar' : '', $store.app.menu, $store.app.layout]">
            ...
            <div class="bg-white dark:bg-black h-full">
                ...
                <div class="flex p-4">
                    <a class='main-logo flex-1 w-full' href='index.html'>
                        <img src="../assets/assetsdashboard/images/logo.svg" alt="logo" class="block dark:hidden" />
                        <img src="../assets/assetsdashboard/images/dark-logo.svg" alt="logo" class="hidden dark:block" />
                    </a>
                </div>
                <!-- End Logo -->
                <!-- Start Menu -->
                <ul class="relative h-[calc(100vh-58px)] flex flex-col gap-1 overflow-y-auto overflow-x-hidden p-4 py-0" x-data="{ activeMenu: 'dashboard' }">
                    ...
                    <li class="menu nav-item">
                        <a href="javaScript:;" class="nav-link group active text-black dark:text-white" :class="{'active' : activeMenu === 'apps'}" @click="activeMenu === 'apps' ? activeMenu = null : activeMenu = 'apps'">
                        ...
                        <ul x-cloak x-show="activeMenu === 'apps'" x-collapse class="sub-menu flex flex-col gap-1 text-black dark:text-white/80">
                            ...
                            <li><a href='?pages=settings'>Setting</a></li>
                        </ul>
                    </li>
                    <li class="menu nav-item">
                    <a href="javaScript:;" class="nav-link group active text-black dark:text-white" :class="{'active' : activeMenu === 'components'}" @click="activeMenu === 'components' ? activeMenu = null : activeMenu = 'components'">
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="pl-1">User Settings</span>
                            </div>
                        </a>
                        <ul x-cloak x-show="activeMenu === 'components'" x-collapse class="sub-menu flex flex-col gap-1 text-black dark:text-white/80">
                            ...
                            <li><a href='?pages=#'>Petugas</a></li>
                            <li><a href='?pages=#'>Calon Siswa</a></li>
                        </ul>
                    </li>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="profile" x-data="dropdown" @click.outside="open = false">
                            <button type="button" class="flex items-center gap-1.5 xl:gap-0" @click="toggle()">
                                <img class="h-7 w-7 rounded-full xl:mr-2" src="../assets/assetsdashboard/images/byewind-avatar.png" alt="Header Avatar" />
                            ...
                            <ul x-cloak x-show="open" x-transition x-transition.duration.300ms>
                                <li>
                                    <div class="flex items-center !p-1">
                                        <div class="flex-none">
                                            <img class="h-7 w-7 rounded-full object-cover" src="../assets/assetsdashboard/images/byewind-avatar.png" alt="image" />
                                        </div>
                                        <div class="pl-2">
                                ...
                                <li class="h-px bg-black/5 block my-1"></li>
                                <li>
                                    <a href="../inc/logout.php" class="text-black dark:text-white flex items-center">
                    ...
                    <div class="flex flex-col gap-7">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-7">
                                ...
                                <div class="flex justify-between gap-3 items-start md:items-center mb-4">
                                    <div class="flex flex-col md:flex-row items-center gap-4">
                                        <ul id="tabs" class="inline-flex gap-1 text-sm font-normal">
                                            <li class="px-1.5 py-1 text-black dark:text-white font-semibold"><a href="javaScript:;">Total Users</a></li>
                                            <li class="px-1.5 py-1 text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white"><a href="javaScript:;">Total Projects</a></li>
                                            <li class="px-1.5 py-1 text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white"><a href="javaScript:;">Operating Status</a></li>
                                        </ul>
                                    ...
                                    <div x-data="{ dropdown: false}" class="dropdown ml-auto">
                                        <a href="javaScript:;" class="text-black dark:text-white" @click="dropdown = !dropdown" @keydown.escape="dropdown = false">
                                            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M9 12.75C9.69036 12.75 10.25 13.3096 10.25 14C10.25 14.6904 9.69036 15.25 9 15.25C8.30964 15.25 7.75 14.6904 7.75 14C7.75 13.3096 8.30964 12.75 9 12.75Z" fill="currentColor" />
                                                <path d="M14 12.75C14.6904 12.75 15.25 13.3096 15.25 14C15.25 14.6904 14.6904 15.25 14 15.25C13.3096 15.25 12.75 14.6904 12.75 14C12.75 13.3096 13.3096 12.75 14 12.75Z" fill="currentColor" />
                                                <path d="M20.25 14C20.25 13.3096 19.6904 12.75 19 12.75C18.3096 12.75 17.75 13.3096 17.75 14C17.75 14.6904 18.3096 15.25 19 15.25C19.6904 15.25 20.25 14.6904 20.25 14Z" fill="currentColor" />
                                            </svg>
                                        </a>
                            ...
                            <div class="bg-lightwhite dark:bg-white/5 p-6 rounded-2xl">
                                <h2 class="text-sm font-semibold text-black dark:text-white mb-4">Traffic by Website</h2>
                                <div class="flex flex-col gap-[18px]">
                                    <div class="flex gap-4 items-center group">
                                        <p class="w-16 flex-none">Google</p>
                                        <div class="w-full h-[6px] relative bg-black/10 dark:bg-white/10 group-hover:bg-black dark:group-hover:bg-white rounded-tr-[4px] rounded-br-[4px] after:h-3 after:w-[1px] after:bg-black/10 dark:after:bg-white/20 group-hover:after:bg-black dark:group-hover:after:bg-white after:absolute after:left-0 after:-top-[3px]"></div>
                                    </div>
                                    <div class="flex gap-4 items-center group">
                                        <p class="w-16 flex-none">Yourtube</p>
                                        <div class="w-1/2 h-[6px] relative bg-black/10 dark:bg-white/10 group-hover:bg-black dark:group-hover:bg-white rounded-tr-[4px] rounded-br-[4px] after:h-3 after:w-[1px] after:bg-black/10 dark:after:bg-white/20 group-hover:after:bg-black dark:group-hover:after:bg-white after:absolute after:left-0 after:-top-[3px]"></div>
                                    </div>
                                    <div class="flex gap-4 items-center group">
                                        <p class="w-16 flex-none">Instagram</p>
                                        <div class="w-10/12 h-[6px] relative bg-black/10 dark:bg-white/10 group-hover:bg-black dark:group-hover:bg-white rounded-tr-[4px] rounded-br-[4px] after:h-3 after:w-[1px] after:bg-black/10 dark:after:bg-white/20 group-hover:after:bg-black dark:group-hover:after:bg-white after:absolute after:left-0 after:-top-[3px]"></div>
                                    </div>
                                    <div class="flex gap-4 items-center group">
                                        <p class="w-16 flex-none">Pinterest</p>
                                        <div class="w-2/5 h-[6px] relative bg-black/10 dark:bg-white/10 group-hover:bg-black dark:group-hover:bg-white rounded-tr-[4px] rounded-br-[4px] after:h-3 after:w-[1px] after:bg-black/10 dark:after:bg-white/20 group-hover:after:bg-black dark:group-hover:after:bg-white after:absolute after:left-0 after:-top-[3px]"></div>
                                    </div>
                                    <div class="flex gap-4 items-center group">
                                        <p class="w-16 flex-none">Facebook</p>
                                        <div class="w-3/5 h-[6px] relative bg-black/10 dark:bg-white/10 group-hover:bg-black dark:group-hover:bg-white rounded-tr-[4px] rounded-br-[4px] after:h-3 after:w-[1px] after:bg-black/10 dark:after:bg-white/20 group-hover:after:bg-black dark:group-hover:after:bg-white after:absolute after:left-0 after:-top-[3px]"></div>
                                    </div>
                                    <div class="flex gap-4 items-center group">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-7">
                            <div class="bg-lightwhite dark:bg-white/5 rounded-2xl p-6">
                                <h2 class="text-sm font-semibold text-black dark:text-white mb-4">Traffic by Device</h2>
    ...
    <!-- All javascirpt -->
    <!-- Alpine js -->
    <script src="../assets/assetsdashboard/js/alpine-collaspe.min.js"></script>
    <script src="../assets/assetsdashboard/js/alpine-persist.min.js"></script>
    <script src="../assets/assetsdashboard/js/alpine.min.js" defer></script>

    <!-- ApexCharts js -->
    <script src="../assets/assetsdashboard/js/apexcharts.js"></script>
    <script src="../assets/assetsdashboard/js/apexcharts-main.js"></script>

    <!-- Custom js -->
    <script src="../assets/assetsdashboard/js/custom.js"></script>
</body>


<!-- Mirrored from snow-tail.netlify.app/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Feb 2025 12:40:31 GMT -->
